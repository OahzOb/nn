...
class Network:
    def __init__(self):
        self.Layers = list()
        self.Layers.append(Layer(input_size=1, output_size=40, activation='ReLU'))
        self.Layers.append(Layer(input_size=40, output_size=40, activation='ReLU'))
        self.Layers.append(Layer(input_size=40, output_size=1, activation='none'))
...
if __name__ == '__main__':
    ...
    for epoch in range(epochs):
        ...
        net.backward(y_true=y0, lr=1e-2)
    y_pred = list()
